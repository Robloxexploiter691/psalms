...
local assetsupport = string.find(identifyexecutor(), "Wave") or string.find(identifyexecutor(), "Seliware") or string.find(identifyexecutor(), "AWP") or string.find(identifyexecutor(), "Argon") or string.find(identifyexecutor(), "Swift") or string.find(identifyexecutor(), "Bunni.lol") or string.find(identifyexecutor(), "Delta") or string.find(identifyexecutor(), "Zenith")
